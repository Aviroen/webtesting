          ...
          >
            <slot name="link1">
              ...
              <div class="footer4-fragment7">
                <span class="footer4-text20">About Us</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link2">
              ...
              <div class="footer4-fragment2">
                <span class="footer4-text15">Contact Us</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link3">
              ...
              <div class="footer4-fragment8">
                <span class="footer4-text21">Tutorials</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link4">
              ...
              <div class="footer4-fragment1">
                <span class="footer4-text14">Resources</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link5">
              ...
              <div class="footer4-fragment6">
                <span class="footer4-text19">Tools</span>
              </div>
            </slot>
          </a>
        </div>
            ...
            <span class="footer4-text11 thq-body-small">
              <slot name="privacyLink">
                ...
                <div class="footer4-fragment3">
                  <span class="footer4-text16">Privacy Policy</span>
                </div>
              </slot>
            </span>
            <span class="thq-body-small">
              <slot name="termsLink">
                ...
                <div class="footer4-fragment5">
                  <span class="footer4-text18">Terms of Use</span>
                </div>
              </slot>
            </span>
            <span class="thq-body-small">
              <slot name="cookiesLink">
                ...
                <div class="footer4-fragment4">
                  <span class="footer4-text17">Cookies Policy</span>
                </div>
              </slot>
            </span>
          </div>
