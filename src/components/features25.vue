            ...
            <h2 class="thq-heading-2">
              <slot name="feature1Title">
                ...
                <div class="features25-fragment1">
                  <span class="features25-text1">Game Development Tutorials</span>
                </div>
              </slot>
            </h2>
              ...
              <slot name="feature1Description">
                ...
                <div class="features25-fragment6">
                  <span class="features25-text6">
                    Access a wide range of tutorials covering various aspects of
                    game development, from beginner to advanced levels.
                  </span>
                </div>
              </slot>
            </span>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature2Title">
                ...
                <div class="features25-fragment3">
                  <span class="features25-text3">Resource Library</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature2Description">
                ...
                <div class="features25-fragment5">
                  <span class="features25-text5">
                    Explore our extensive library of resources including asset
                    packs, code snippets, and design templates to enhance your
            ...
            <h2 class="thq-heading-2">
              <slot name="feature3Title">
                ...
                <div class="features25-fragment4">
                  <span class="features25-text4">Interactive Tools</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature3Description">
                ...
                <div class="features25-fragment2">
                  <span class="features25-text2">
                    Utilize interactive tools such as game engines, level editors,
                    and debugging utilities to streamline your game development
                    workflow.
                  </span>
                </div>
              </slot>
...
export default {
  ...
  props: {
    feature1ImgAlt: {
      type: String,
      default: 'Game Development Tutorials Image Alt Text',
    },
    feature3ImgAlt: {
      type: String,
      default: 'Interactive Tools Image Alt Text',
    },
    feature2ImgAlt: {
      type: String,
      default: 'Resource Library Image Alt Text',
    },
    feature2ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1611371805429-8b5c1b2c34ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTQwMXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature3ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1585079542156-2755d9c8a094?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTQwMHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature1ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTQwMHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
  },
  data() {
    return {
