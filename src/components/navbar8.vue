            ...
            <a :href="link2Url" class="thq-body-small thq-link">
              <slot name="link2">
                ...
                <div class="navbar8-fragment23">
                  <span class="navbar8-text27">/tutorials</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link32 thq-body-small thq-link">
              <slot name="link3">
                ...
                <div class="navbar8-fragment13">
                  <span class="navbar8-text17">/tools</span>
                </div>
              </slot>
            </a>
                ...
                <span class="thq-body-small thq-link">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text20">/community</span>
                    </div>
                  </slot>
                </span>
                    ...
                    <div class="navbar8-content1">
                      ...
                      <span class="thq-body-small">
                        <slot name="page1Description">
                          ...
                          <div><span>Explore our resources and tools</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="navbar8-content2">
                      ...
                      <span class="thq-body-small">
                        <slot name="page2Description">
                          ...
                          <div>
                            <span>Learn from our step-by-step guides</span>
                          </div>
                        </slot>
                      </span>
                    </div>
                    ...
                    <div class="navbar8-content3">
                      ...
                      <span class="thq-body-small">
                        <slot name="page3Description">
                          ...
                          <div>
                            <span>Access useful tools for game development</span>
                          </div>
                        </slot>
                      </span>
                    </div>
                    ...
                    <div class="navbar8-content4">
                      ...
                      <span class="thq-body-small">
                        <slot name="page4Description">
                          ...
                          <div>
                            <span>Join our community of game developers</span>
                          </div>
                        </slot>
                      </span>
                    </div>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment21">
                    <span class="navbar8-text25">Main Action</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment15">
                    <span class="navbar8-text19">Secondary Action</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span class="navbar8-page12 thq-body-large">
                  <slot name="page1">
                    ...
                    <div class="navbar8-fragment12">
                      <span class="navbar8-text16">Home</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment10">
                      <span class="navbar8-text14">Tutorials</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment18">
                      <span class="navbar8-text22">
                        Learn from our step-by-step guides
                      </span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="navbar8-page32 thq-body-large">
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment19">
                      <span class="navbar8-text23">Tools</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page3Description">
                    ...
                    <div class="navbar8-fragment20">
                      <span class="navbar8-text24">
                        Access useful tools for game development
                      </span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment11">
                      <span class="navbar8-text15">Community</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
...
export default {
  ...
  props: {
    ...
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1576669421254-0a039e301587?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTQwMHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1721333088904-5f3e01559708?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTM5OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1531593773601-7a75ca4cd915?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTM5OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page1ImageAlt: {
      type: String,
      default: 'Home Icon',
    ...
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1612729187471-94e030a9f551?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNTAxNTM5OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    linkUrlPage4: {
      type: String,
      default: 'https://www.teleporthq.io',
